...
function quran_verse(){
  $(document).ready(function () {
    $.ajax({
      type: "GET",
      url: "https://quranapi.azurewebsites.net/api/verse/?lang=en",
      cache: false,
      dataType: "xml",
  ...
  $(document).ready(function () {
    $.ajax({
      ...
      success: function(json) {
        ...
        passage = ambig(response.text).replace('<a style="" target="_blank" href="http://net[Holy Text].com/net-[Holy Text]-preface">©NET</a>', "");
        bible = true;
